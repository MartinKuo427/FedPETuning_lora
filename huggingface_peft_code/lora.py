...
class LoraModel(torch.nn.Module):
    ...
    **Attributes**:
    ...
    # martinc function
    def reset_all_lora_parameters(self):
        ...
        for key in key_list:
            ...
            if isinstance(target, LoraLayer):
                # bias = target.bias is not None
                # new_module = torch.nn.Linear(target.in_features, target.out_features, bias=bias)
                target.manual_reset_lora_parameters()
...
class Linear(nn.Linear, LoraLayer):
    ...
    # martinc function
    def manual_reset_lora_parameters(self):
        self.reset_lora_parameters(self.active_adapter)
